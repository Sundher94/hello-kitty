...
output "aws_s3_asdas_2_bucket_website_endpoint" {
  value = module.appcd_6d1dd9ef-de7c-4d53-ad43-b1000df1fbf9.bucket_website_endpoint
  sensitive = false
}


output "aws_s3_asdas_2_kms_arn" {
  value = module.appcd_6d1dd9ef-de7c-4d53-ad43-b1000df1fbf9.kms_arn
  sensitive = false
}


output "aws_s3_asdas_2_arn" {
  value = module.appcd_6d1dd9ef-de7c-4d53-ad43-b1000df1fbf9.arn
  sensitive = false
}


output "aws_s3_asdas_2_bucket_name" {
  value = module.appcd_6d1dd9ef-de7c-4d53-ad43-b1000df1fbf9.bucket_name
  sensitive = false
}
